...
import com.micrantha.skouter.ui.scan.components.drawScanBox
import com.micrantha.skouter.ui.scan.components.drawScanMask
...
class ScanScreen : Screen {
    ...
    private fun BoxScope.ScannedOverlays(
        ...
        Canvas(
            ...
            data.forEach {
                when (it) {
                    is ScanBox -> drawScanBox(it, textStyle, measurer)
